...
from bitsea.general import mask
from bitsea.general import NetCDF_phys_Files
from bitsea.general import NetCDF_phys_Vars
from bitsea.general import space_intepolator_griddata


def argument():
    parser = argparse.ArgumentParser(
        description="""Creates ready IC files for MITgcm
...
def writeCheckFile(M, OUTPUTDIR, var, Mask2):
    Mcheck = M.copy()
...
def main(
    inputdir, outputdir, nativemask, outmaskfile, modelvarlist, time, **kwargs
):
    ...
    if modelvarlist:
        ...
        for var in MODELVARS:
            ...
            writeCheckFile(M, OUTPUTDIR, var, Mask2)
